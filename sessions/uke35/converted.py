...
print(a)
print(type(a))
print(dir(a))#Element3
print(a)
a[2]#Element 1
a[0]a[2] = 2+2 #Vi endrer element nr 3, som har indeks 2
...
siste = a.pop()
print("siste", siste, "\nRest", a)#Legg til et element på slutten:
a.append(3.14)
print(a)
# "Pop" første element
first = a.pop(0)
print("Første:", first, "\nRest", a)print("Lengden på liste a er:", len(a))
print("Største element er:", max(a))import math
...
for tall in a:
    print(tall)# Lag en liste b hvor elementene er dobbelt av de i a:
a = [1,2,3,4,5]
b = []
for tall in a:
    dobbelt = tall*2
    b.append(dobbelt)
print(b)%%html
<iframe width="800" height="500" frameborder="0" src="https://pythontutor.com/iframe-embed.html#code=%23%20Lag%20en%20liste%20b%20hvor%20elementene%20er%20dobbelt%20av%20de%20i%20a%3A%0Aa%20%3D%20%5B1,2,3,4,5%5D%0Ab%20%3D%20%5B%5D%0Afor%20tall%20in%20a%3A%0A%20%20%20%20dobbelt%20%3D%20tall*2%0A%20%20%20%20b.append%28dobbelt%29%0Aprint%28b%29&codeDivHeight=400&codeDivWidth=350&cumulative=false&curInstr=19&heapPrimitives=nevernest&origin=opt-frontend.js&py=3&rawInputLstJSON=%5B%5D&textReferences=false"> </iframe>#range(«stop») gir en "range" fra 0 til (men ikke med) «stop»
print(list(range(10)))
...
for i, tall in enumerate(a):
    print("På indeks", i, "har vi", tall)a = [1,2,3,4,5]
b = ["Norge", "Sverige", "Danmark"]
c = [5,6,7,8,9]
print(list(zip(a,b,c))) #Merk at b er kortere enn a og c
for tall1, land, tall2 in zip(a,b,c):
    print("minste tall", tall1, "land", land, "største tall", tall2)import matplotlib.pyplot as plt #Importer pyplot fra matplotlib og gi det synonymet plt
...
plt.xlabel("x-aksetittel")
plt.ylabel("y-aksetittel")
plt.show()#Plotte flere grafer i samme plott
def f(x):
...
plt.show()import numpy as np #importer numpy med synonym np
