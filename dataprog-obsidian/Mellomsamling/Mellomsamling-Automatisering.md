...
::: credit
By Micthev - Own work, CC BY-SA 4.0,
via [Wikimedia Commons](https://commons.wikimedia.org/w/index.php?curid=10051289)
:::
...
![[Data_warehouse_architecture.jpg]]

::: credit
By Soha jamil - Own work, CC BY-SA 4.0, 
via [Wikimedia Commons](https://commons.wikimedia.org/w/index.php?curid=46448452)
:::

note:
Hvordan kan vi få godt samarbeid mellom datavarehus og sluttbrukere for å sikre god tilgang til relevante data og automatiserte analyser?
...
Det beste er som regel å bruke begge tankesett. Hvis vi bare prøver og feiler, blir koden ofte rotete og det er begrenset hvor mange eksempler vi kan teste. Hvis vi bare tenker analytisk bruker vi gjerne endeløst med tid på tilfeller som aldri forekommer i praksis, men det blir lettere å holde struktur på koden.
...
redigeringsprogrammet.  For det første kan den kjøre koden direkte.
