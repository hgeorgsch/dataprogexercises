### Eksempler på gode utgangspunkter til prosjektoppgave

Vi har sett litt på mappeinnleveringer fra tidligere år, og legger frem noen eksempler på oppgaver som har fungert godt.
Utgangspunktet var litt annerledes i fjor: Studentene ble bedt om å levere en rapport, vurderingskriteriene er var annerledes.
I tillegg skulle de levere 2 oppgaver innen *dataanalyse* (dere kan gjøre en oppgave innen simulering, om dere vil) og 1 av de *måtte* bruke data fra SSB
Problemstillingene ville vært gode utgangspunkt til deres essay i år også.

* Student har som mål å undersøke formel 1 seire: Student henter inn data gjennom et WebAPI, trekker ut og aggregerer data og lager tabulær og grafisk fremstilling av antall seire per lag, gjennomsnittlige sire per år for de ulike lagene, og undersøker hvilke lag som bruker mercedes motor.
