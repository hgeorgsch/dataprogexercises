...
![[IEEE_754_Double_Floating_Point_Format.svg|900]]


$$ \textcolor{cyan}{\pm} \textcolor{red}{m}  \cdot 2^\textcolor{SeaGreen}{a} $$
<!-- element style="font-size: 160%  ; " -->

::: credit
By Codekaizen - Own work, CC BY-SA 4.0, 
via [Wikimedia Commons](https://commons.wikimedia.org/w/index.php?curid=3595583)
...
+ Flyttalspresisjon
+ Trunkering i numeriske algoritmar 
+ Feilpropagering
+ Målefeil
+ Estimeringsfeil i statistiske data
+ Manglande data
...
+ dropp radar
+ interpolasjon
+ set inn null eller ein annan vilkårleg verdi
