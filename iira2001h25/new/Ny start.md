...
Alt materiale vert distribuert som del av denne vevsida.
Mange av sidene er Jupyter Notebook-dokument sjølv om sjølve vevsida
ikkje er redigerbar.  De kan lasta ned slike sider som ipynb-filer
frå nedlastingsmenyen øvst på sida, og det er meininga at de skal
gjera det, og eksperimentera med døme og oppgåver i Jupyter Lab.
Sider som berre kan lastast ned som PDF eller markdown (MD) inneheld
ikkje kode og er ikkje meint for Jupyter.

Gjennomføringa av emnet vert vurdert etter ei mappe.  Denne skulle innehalda
to delar.
+ **Del 1** skulle visa breidd i emnet, gjennom eit utval eit utval av dei utdelte
  oppåvene som de har arbeidd med.
...
+ 20. oktober: Nytt stoff i dataanalyse
    + 21. og 23. oktober: Vegleiing på oppgåvene
