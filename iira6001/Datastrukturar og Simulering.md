...
+ *Gjennomarbeidde Døme.*
	+ [Tilfeldigheit](notebook/Tilfeldigheit.ipynb)
	+ [Marknadssimulering](notebook/Marknadssimulering.ipynb)
	+ [Listekomprehensjon](notebook/Listekomprehensjon.ipynb)
	+ [](notebook/JSON%20og%20dict.ipynb) (valfri).
...
+ [](notebook/Tilfeldigheit-Demo.ipynb) viser korleis plotta til føredraget om
